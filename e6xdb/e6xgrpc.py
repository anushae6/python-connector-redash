...
class Connection(object):
    ...
    def get_session_id(self):
        ...
        if not self._session_id:
            try:
                ...
                authenticate_request = e6x_engine_pb2.AuthenticateRequest(user=self.__username,
    ...
    def dry_run(self, query):
        dry_run_request = e6x_engine_pb2.DryRunRequest(sessionId=self.get_session_id, schema=self._database,
                                                       queryString=query)
    ...
    def get_columns(self, database, table):
        get_columns_request = e6x_engine_pb2.GetColumnsRequest(sessionId=self.get_session_id, schema=database,
                                                               table=table)
...
class Cursor(DBAPICursor):
    ...
    def execute(self, operation, parameters=None, **kwargs):
        ...
        client = self.connection.client
        prepare_statement_request = e6x_engine_pb2.PrepareStatementRequest(sessionId=self.connection.get_session_id,
                                                                           schema=self._database, queryString=sql)
    ...
    def update_mete_data(self):
        result_meta_data_request = e6x_engine_pb2.GetResultMetadataRequest(engineIP=self._engine_ip,
                                                                           sessionId=self.connection.get_session_id,
                                                                           queryId=self._query_id)
    ...
    def fetch_batch(self):
        ...
        client = self.connection.client
        get_next_result_batch_request = e6x_engine_pb2.GetNextResultBatchRequest(engineIP=self._engine_ip,
                                                                                 sessionId=self.connection.get_session_id,
                                                                                 queryId=self._query_id)
    ...
    def fetchone(self):
        ...
        rows_to_return = []
        client = self.connection.client
        get_next_result_row_request = e6x_engine_pb2.GetNextResultRowRequest(engineIP=self._engine_ip,
                                                                             sessionId=self.connection.get_session_id,
                                                                             queryId=self._query_id)
    ...
    def explain(self):
        explain_request = e6x_engine_pb2.ExplainRequest(engineIP=self._engine_ip,
                                                        sessionId=self.connection.get_session_id,
                                                        queryId=self._query_id)
    ...
    def explain_analyse(self):
        explain_analyze_request = e6x_engine_pb2.ExplainAnalyzeRequest(engineIP=self._engine_ip,
                                                                       sessionId=self.connection.get_session_id,
                                                                       queryId=self._query_id)
